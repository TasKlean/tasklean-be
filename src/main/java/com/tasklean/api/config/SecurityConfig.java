...
public class SecurityConfig {
    ...
    /** Configures the HTTP security filter chain: CORS, CSRF off, stateless sessions, JWT filter, authorization rules. */
    @Bean
    ...
    // Prevents Spring Boot from auto-registering the @Component filter as a servlet filter,
    // which would cause it to run twice (once as servlet filter, once in the security chain)
    @Bean
